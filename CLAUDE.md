...
> **Cursor 修复（2026-07-23 · 跨 lot probe card 路由）：** [`docs/HANDOFF_CURSOR_FIX_CROSS_LOT_PROBE_CARD_ROUTING_2026-07-23.md`](docs/HANDOFF_CURSOR_FIX_CROSS_LOT_PROBE_CARD_ROUTING_2026-07-23.md) — 近N月+bin×卡+lot列表勿被单 lot P-F 抢答；`probe card` 进 `bin_card_attribution`；⏭ pm2 reload 复验。  
> **Cursor 修复（2026-07-23 · mask 测试情况 lot 富表）：** [`docs/HANDOFF_CURSOR_FIX_MASK_LOT_LISTING_RICH_2026-07-23.md`](docs/HANDOFF_CURSOR_FIX_MASK_LOT_LISTING_RICH_2026-07-23.md) — `P02G` 等 mask 概况 → `lot_listing` 富表（良率/坏 bin/DUT/平均良率/前20）；禁单 lot「坏 BIN 分布」图；⏭ 真库 P02G 复验。
