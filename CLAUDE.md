...
> **探针卡/测试机组合良率排名（2026-07-09 设计 / 2026-07-10 实现）：** [`docs/HANDOFF_AGENT_PROBE_CARD_TESTER_PERFORMANCE.md`](docs/HANDOFF_AGENT_PROBE_CARD_TESTER_PERFORMANCE.md) — `aggregate_probe_card_tester_performance`；组合/探针卡排名+置信度档位+月度趋势+坏bin频率；仅 JB STAR，v1 无前端面板。
