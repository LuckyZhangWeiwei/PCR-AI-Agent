...
> **探针卡/测试机组合良率排名（2026-07-09 设计 / 2026-07-10 实现 / 2026-07-11 终审修复）：** [`docs/HANDOFF_AGENT_PROBE_CARD_TESTER_PERFORMANCE.md`](docs/HANDOFF_AGENT_PROBE_CARD_TESTER_PERFORMANCE.md) — `aggregate_probe_card_tester_performance`；组合/探针卡排名+置信度档位+月度趋势+坏bin频率；仅 JB STAR，v1 无前端面板；良率下限钳制于 0。**真库测试任务：** [`docs/HANDOFF_CURSOR_REALDB_PROBE_CARD_TESTER_PERFORMANCE_2026-07-11.md`](docs/HANDOFF_CURSOR_REALDB_PROBE_CARD_TESTER_PERFORMANCE_2026-07-11.md) — ⏭ 待 Cursor 用真库验证（本地全程 Dummy 模式开发，从未跑过真实 Oracle 路径）。
