...
> **Agent JB 同 slot 换卡（CARDID）：** [`docs/HANDOFF_AGENT_JB_PROBE_CARD_CHANGE.md`](docs/HANDOFF_AGENT_JB_PROBE_CARD_CHANGE.md) — `cardChangesBySlot`、`slotBadBinsCompact` 按 (slot,cardId)、`recentLotsByTestEnd.cardIds`。  
